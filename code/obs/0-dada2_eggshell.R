...
#Set file paths
path <- "data/obs/bioinfo/fastq/eggshell"
...
#save sequence table
saveRDS(seqtab,
        "data/obs/bioinfo/seqtab_eggshell.rds")
...
head(taxa.print)
capture.output(taxa.print, file ="data/obs/bioinfo/taxa_eggshell_dada2.txt")

# Clean and save environment ----------------------------------------------

#Save environment
save.image("data/obs/bioinfo/0-dada2_eggshell_complete.RData")
...
save.image("data/obs/bioinfo/0-dada2_eggshell.RData")
